...
mod tests {
    ...
    fn test_parse_vertex1() {
        let mut parser_state = ParserState::new("v -1.929448 13.329624 -5.221914\n");
    ...
    fn test_parse_vertex2() {
        let mut parser_state = ParserState::new("v -1.929448 13.329624 -5.221914 1.329624\n");
        let parser = super::VertexParser::new();
    ...
    fn test_parse_vertex3() {
        let mut parser_state = ParserState::new("v -1.929448 13.329624 \n");
        let parser = super::VertexParser::new();
    ...
    fn test_parse_vertex4() {
        let mut parser_state = ParserState::new("v -1.929448 13.329624 -5.221914 1.329624\n v");
        let parser = super::VertexParser::new();
        assert!(parser.parse(&mut parser_state).is_ok());
    }
